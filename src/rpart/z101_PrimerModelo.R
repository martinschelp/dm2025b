...
modelo_final <- rpart(
    ...
    xval = 0,
    cp = -0.065748, # esto significa no limitar la complejidad de los splits
    minsplit = 3094, # minima cantidad de registros para que se haga el split
    minbucket = 1543, # tamaño minimo de una hoja
